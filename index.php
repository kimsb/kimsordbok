      ...
      <div class='row well well-md'>
        <div class='col-md-12'>
		  ...
		  <form class="search-form" action="index.php" method="POST">
						...
						<input type="text" autofocus id="search-word" name="query" value="<?php if (isset($_POST['query'])) {																														 //autofocus pattern="^[a-zA-ZæøåÆØÅ]*-?[a-zA-ZæøåÆØÅ]*$" required title="Kun bokstaver og maks 1 blank(-)"
							echo $_POST['query']; } ?>" onfocus="this.setSelectionRange(0, this.value.length)" onclick="this.setSelectionRange(0, this.value.length)" autocorrect="off" autocomplete="off" maxlength="10">
      ...
      <div class='row'>
        ...
        <div class='col-md-12'>
          <div class='panel-group'>
            <div class='panel panel-success <?php if(empty($yesArray)) {echo "hidden";} ?>'>
              <div class='panel-heading'>
                <h4 class='panel-title'>
                  <a data-toggle='collapse' href='#systemsOperational'><i class='glyphicon glyphicon-ok-sign' id="panel-i"></i>Godkjente ord</a>
                </h4>
              </div>
              <div id='systemsOperational' class='panel-collapse collapse in'>
                <div class='panel-body'>
                  <ul class='list-unstyled'>
					...
					<li><a onclick='editValid(this)'><?= str_replace($replacements, $vowels, $yesWord); ?></a></li>
					<?php endforeach; ?>
                  </ul>
                </div>
              </div>
            ...
            <div class='panel panel-warning <?php if(empty($maybeArray)) {echo "hidden";} ?>'>
              <div class='panel-heading'>
                <h4 class='panel-title'>
                  <a data-toggle='collapse' href='#weatherAlert'><i class='glyphicon glyphicon-question-sign' id="panel-i"></i>Ord som kanskje er godkjent</a>
                </h4>
              </div>
              <div id='weatherAlert' class='panel-collapse collapse in'>
                <div class='panel-body'>
                  <ul class='list-unstyled'>
					...
					<li><a onclick='editUncertain(this)'><?= str_replace($replacements, $vowels, $maybeWord); ?></a></li>
					<?php endforeach; ?>
                  </ul>
                </div>
              </div>
